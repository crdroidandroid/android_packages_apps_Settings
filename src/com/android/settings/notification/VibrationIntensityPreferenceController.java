...
public class VibrationIntensityPreferenceController extends BasePreferenceController {
    ...
    public VibrationIntensityPreferenceController(Context context, String key) {
        super(context, key);
        mSupportsMultipleIntensities = context.getResources().getBoolean(
    ...
    public int getAvailabilityStatus() {
        return mSupportsMultipleIntensities && mVibrator != null ? AVAILABLE : UNSUPPORTED_ON_DEVICE;
    }
}
