...
import com.crdroid.settings.fragments.misc.thermal.PreferencesProvider;
import com.crdroid.settings.fragments.misc.thermal.ThermalProfiles;
...
public class ThermalControlPerAppPreferenceController extends BasePreferenceController
    ...
    public int getAvailabilityStatus() {
        if (TextUtils.isEmpty(mPackageName) || mPackageManager.getLaunchIntentForPackage(mPackageName) == null ||
                isLauncherApp(mPackageName) || Arrays.asList(hideApps).contains(mPackageName) ||
                !ThermalProfiles.isAllowed(mContext) || !ThermalProfiles.isAvailable()) {
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        mPref.setValue(Integer.toString(PreferencesProvider.getProfile(mPackageName, mContext)));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        PreferencesProvider.setProfile(mPackageName, profile, mContext);
    ...
    public CharSequence getSummary() {
        int value = PreferencesProvider.getProfile(mPackageName, mContext);
