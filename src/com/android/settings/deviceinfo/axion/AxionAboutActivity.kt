...
class AxionAboutActivity : ComponentActivity() {
    ...
    private fun navigateToDeviceInfo() {
        val intent = Intent(this, MyDeviceInfoActivity::class.java)
