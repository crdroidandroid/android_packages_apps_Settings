...
public class RecentsPanelSettings extends SettingsPreferenceFragment implements
        DialogCreatable, Preference.OnPreferenceChangeListener, Indexable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRecentPanelScale = (SlimSeekBarPreference) findPreference(RECENT_PANEL_SCALE);
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
           new BaseSearchIndexProvider() {
               ...
               public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                   ...
                   sir.xmlResId = R.xml.recents_panel_settings;
                   result.add(sir);
